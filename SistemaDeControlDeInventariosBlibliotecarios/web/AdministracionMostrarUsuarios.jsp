            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-center" >
                        ...
                        <div class="row">
                            <div class="col-12 text-center" >
                                <a class="btn btn-primary btn-block" href="AgregarUsuario_1.jsp">Agregar</a>
                                <table class="table table-striped" width="100%" border="2" cellspacing="1">
                                    ...
                                    <c:forEach items="${lista}" var="ver">
                                        <tr>
                                            ...
                                            <td>${ver.nombre}</td>
                                            <td><a class="btn btn-info btn-block" href="usuario?action=MostrarUno&id=${ver.id}">Modificar</a></td>

                                            <td><a class="btn btn-danger btn-block" href="usuario?action=Borrar&id=${ver.id}">Borrar</a></td>
                                        </tr>
                                    </c:forEach>
                                </table>
