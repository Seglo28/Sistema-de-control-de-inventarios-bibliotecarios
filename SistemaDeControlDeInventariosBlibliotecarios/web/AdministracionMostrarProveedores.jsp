        ...
        <div class="container">
            <div class="row">              
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-12 text-center" >
                            <a class="btn btn-primary btn-block" href="AgregarProveedor.jsp">Agregar</a></td>
                            <table class="table table-striped" width="100%" border="2" cellspacing="1">
                                ...
                                <c:forEach items="${lista}" var="ver">
                                    <tr>
                                        ...
                                        <td>${ver.telefono}</td>
                                        <td><a class="btn btn-info btn-block" href="pc?action=MostrarUno&id_proveedor=${ver.id_proveedor}">Modificar</a></td>

                                        <td><a class="btn btn-danger btn-block" href="pc?action=Borrar&id_proveedor=${ver.id_proveedor}">Borrar</a></td>
